...
const PDFViewerApplication = {
      ...
      this.pdfSidebar.onUpdateThumbnails = () => {
        for (const pageView of pdfViewer.getCachedPageViews()) {
          if (pageView.renderingState === _ui_utils.RenderingStates.FINISHED) {
            ...
            (_this$pdfThumbnailVie = this.pdfThumbnailViewer.getThumbnail(pageView.id - 1)) === null || _this$pdfThumbnailVie === void 0 ? void 0 : _this$pdfThumbnailVie.setImage(pageView);
          }
        }
  ...
  async close() {
    ...
    if (this.pdfDocument) {
      ...
      (_this$pdfThumbnailVie2 = this.pdfThumbnailViewer) === null || _this$pdfThumbnailVie2 === void 0 ? void 0 : _this$pdfThumbnailVie2.setDocument(null);
  ...
  load(pdfDocument) {
    ...
    (_this$pdfThumbnailVie3 = this.pdfThumbnailViewer) === null || _this$pdfThumbnailVie3 === void 0 ? void 0 : _this$pdfThumbnailVie3.setDocument(pdfDocument);
  ...
  _cleanup() {
    ...
    (_this$pdfThumbnailVie4 = this.pdfThumbnailViewer) === null || _this$pdfThumbnailVie4 === void 0 ? void 0 : _this$pdfThumbnailVie4.cleanup();
...
function webViewerPageRendered(_ref7) {
  ...
  if (((_PDFViewerApplication3 = PDFViewerApplication.pdfSidebar) === null || _PDFViewerApplication3 === void 0 ? void 0 : _PDFViewerApplication3.visibleView) === _ui_utils.SidebarView.THUMBS) {
    ...
    if (pageView) {
      thumbnailView === null || thumbnailView === void 0 ? void 0 : thumbnailView.setImage(pageView);
    }
  }
  if (error) {
...
class PDFFindController {
  ...
  #shouldDirtyMatch(state) {
    ...
    switch (state.type) {
      case "again":
        ...
        return pageNumber >= 1 && pageNumber <= linkService.pagesCount && pageNumber !== linkService.page && !(((_this$onIsPageVisible = this.onIsPageVisible) === null || _this$onIsPageVisible === void 0 ? void 0 : _this$onIsPageVisible.call(this, pageNumber)) ?? true);
  ...
  #updateUIState(state) {
    ...
    this._eventBus.dispatch("updatefindcontrolstate", {
      ...
      previous,
      matchesCount: this.#requestMatchesCount(),
      rawQuery: ((_this$state = this.#state) === null || _this$state === void 0 ? void 0 : _this$state.query) ?? null
    });
  }
}
    ...
    Promise.all([firstPagePromise, permissionsPromise]).then(_ref2 => {
      ...
      if (annotationEditorMode !== _pdfjsLib.AnnotationEditorType.DISABLE) {
        ...
        if (pdfDocument.isPureXfa) {
          ...
          this.#annotationEditorUIManager = new _pdfjsLib.AnnotationEditorUIManager(this.container, this.eventBus, pdfDocument === null || pdfDocument === void 0 ? void 0 : pdfDocument.annotationStorage);
          if (mode !== _pdfjsLib.AnnotationEditorType.NONE) {
...
class PDFPageView {
  ...
  reset() {
    var _this$annotationLayer, _this$annotationEdito, _this$xfaLayer, _this$textLayer, _this$structTreeLayer3;
    let {
      keepZoomLayer = false,
...
class AnnotationLayerBuilder {
  ...
  async render(viewport) {
    ...
    if (!this.#onPresentationModeChanged) {
      ...
      (_this$_eventBus = this._eventBus) === null || _this$_eventBus === void 0 ? void 0 : _this$_eventBus._on("presentationmodechanged", this.#onPresentationModeChanged);
    }
  }
  cancel() {
    this._cancelled = true;
    if (this.#onPresentationModeChanged) {
      ...
      (_this$_eventBus2 = this._eventBus) === null || _this$_eventBus2 === void 0 ? void 0 : _this$_eventBus2._off("presentationmodechanged", this.#onPresentationModeChanged);
